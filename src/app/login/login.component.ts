...
export class LoginComponent implements OnInit {
  ...
  login() {
    ...
    // Mã hóa mật khẩu
    const encryptedText = this.encryptUsingAES(this.loginForm.value.password,this.key);
    console.log("mk: " + encryptedText+" key: "+this.key)
  ...
  // Hàm mã hóa AES
encryptUsingAES(textToEncrypt: string, secretKey: string): string {
